...
import aboutImg from '../assets/img/441.jpg'
...
function About(){
    return(
        <div>
            ...
            <section
            id="about"
            className="text-white bg-gray-1 px-10 pb-8 pt-20 dark:bg-dark-2 lg:pb-[70px] lg:pt-[120px]"
            >
            <div className="container">
                ...
                <div className="-mx-4 flex flex-wrap items-center">
                    ...
                    <div className="mb-12 max-w-[540px] lg:mb-0">
                        <h2
                        className="mb-5 text-3xl font-bold leading-tight text-yellow-500 dark:text-white sm:text-[40px] sm:leading-[1.2]"
                        >
                        Brilliant Toolkit to Build Nextgen Website Faster.
                        </h2>
                        <p
                        className="mb-10 text-base leading-relaxed text-white dark:text-dark-6"
                        >
