...
function LandingPage(){
    return(
    <div className="h-full" style={{backgroundImage: `url(${bg})`, backgroundSize: 'auto', backgroundRepeat: 'no-repeat'}}>  
        <Navbar/>
        <div className="pt-20 flex justify-center items-center">
            ...
            <img className="w-full" src={blockImage} alt="" />  
            </div>
            
        </div>
        <section className="flex justify-center pb-8 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px]">
            <div className="container">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        ...
                        <h2
                            className="mb-3 text-3xl font-bold text-white dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]"
                        >
                            Main Features Of Play
                        </h2>
                        <p className="text-base text-white dark:text-white-6">
                ...
                <div className="-mx-4 flex justify-center items-center flex-wrap">
                    <div className="w-full flex justify-center px-4 md:w-1/2 lg:w-1/4">
                        <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
                            ...
                            <p className="mb-8 text-white dark:text-white-6 lg:mb-9">
                                Lorem Ipsum is simply dummy text of the printing and industry.
                            </p>
                            <a
                                href="javascript:void(0)"
                                className="text-base font-medium text-white hover:text-primary dark:text-white dark:hover:text-primary"
                            >
                                Learn More
                            </a>
                        </div>
        ...
        <div className="max-w-screen-xl text-white w-full mx-auto pb-10 min-h-sceen">
          <div className="flex flex-col items-center w-full">
            <h2 className="font-bold text-white text-5xl mt-5 tracking-tight">FAQ</h2>
            <p className="text-neutral-500 text-xl mt-3">Frequenty asked questions</p>
          </div>
          <div className="grid divide-y divide-neutral-200 w-5/6 px-2 mx-auto mt-8">
            <div className="py-5">
              <details className="group">
                ...
                <p className="text-neutral-600 mt-3 group-open:animate-fadeIn">mentorme menawarkan mentorship one-on-one yang dapat membantu kamu dalam melakukan penelitian ilmiah sesuai dengan kaidah yang baik dan benar.</p>
              </details>
            </div>
            <div className="py-5">
              <details className="group">
            ...
            <div className="py-5 mb-8">
              <details className="group">
                ...
                <p className="text-neutral-600 mt-3 group-open:animate-fadeIn">Dalam pengembangan mentorme nantinya akan memberikan tawaran menarik seperti potongan fee mentoring atau bahkan biaya mentoring gratis</p>
              </details>
            </div>
          </div>
        </div>      
